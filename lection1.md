...
![Локализация корня](localization.png)
---
...
![График функции](iteration_exp.png)
...
![Геометрический смысл метода Ньютона](newton.png)
...
![Модифицированный метод Ньютона](newton_modified.png)
